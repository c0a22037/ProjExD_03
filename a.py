...
class Bird:
    ...
    def update(self, key_lst: list[bool], screen: pg.Surface):
        ...
        if not (sum_mv[0] == 0 and sum_mv[1] == 0):  # キーが押されていなくなかったら
...
class Bomb:
    ...
    def __init__(self):
        ...
        爆弾円Surfaceを生成する
        """
        color = random.choice(Bomb.colors)  # __class__.colors
...
def main():
    ...
    bird = Bird(3, (900, 400))
    bombs = [Bomb() for i in range(NUM_OF_BOMBS)]  # BombインスタンスがNUM個並んだリスト
    beam = None
    score = Score()
